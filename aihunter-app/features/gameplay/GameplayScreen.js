...
const styles = StyleSheet.create({
  ...
  tellsSubheading: { fontSize: 13, fontFamily: fonts.bold, color: colors.textPrimary, textTransform: 'uppercase', letterSpacing: 1.5, textAlign: 'center' },
  ...
  tellBadge:       { width: 28, height: 28, borderRadius: 14, backgroundColor: colors.surface2, alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
  tellBadgeNum:    { fontSize: 14, fontFamily: fonts.bold, color: colors.textPrimary },
  tellLabel:       { fontSize: 18, fontFamily: fonts.bold, color: colors.textPrimary, flex: 1 },
